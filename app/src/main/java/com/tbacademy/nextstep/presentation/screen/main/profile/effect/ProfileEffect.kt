...
sealed interface ProfileEffect {
    ...
    data class NavigateToGoalScreen(val goalId: String, val goalTitle: String, val ownGoal: Boolean, val isActive: Boolean, val hasMilestones: Boolean): ProfileEffect
}